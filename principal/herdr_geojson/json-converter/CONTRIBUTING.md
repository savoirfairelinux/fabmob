# How to contribute to herdr-json-converter?
...
- What is the version of the herdr-json-converter app?
...
```
$ git clone github.com/kafitz/json-converter.git
$ cd json-converter
$ git remote add fork git://github.com/yourusername/json-converter.git
```
...
Go to https://github.com/yourusername/json-converter and select your branch. Click the 'Pull Request' button and fill out the form.
...
The herdr-json-converter is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/kafitz/json-converter/issues/new
...
[localization]: https://github.com/kafitz/json-converter/blob/master/README.md#localization
