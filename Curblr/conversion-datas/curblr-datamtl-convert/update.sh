...
# montreal datas 
#       old - wget -N -P data http://donnees.ville.montreal.qc.ca/dataset/8ac6dd33-b0d3-4eab-a334-5a6283eb7940/resource/52cecff0-2644-4258-a2d1-0c4b3b116117/download/signalisation_stationnement.geojson
#       old - wget -N -P data http://donnees.ville.montreal.qc.ca/dataset/c5bf5e9c-528b-4c28-b52f-218215992e35/resource/0795f422-b53b-41ca-89be-abc1069a88c9/download/signalisation-codification-rpa.json

wget -N -P data https://storage.googleapis.com/dx-montreal/resources/52cecff0-2644-4258-a2d1-0c4b3b116117/signalisation_stationnement.geojson
wget -N -P data https://storage.googleapis.com/dx-montreal/resources/0795f422-b53b-41ca-89be-abc1069a88c9/signalisation-codification-rpa.json
echo "done"
...
node segment_to_curblr.js > ../erwin_fork/curb-map/src/assets/data/mtl-subset-segment_all.curblr.json             

# node segment_to_curblr.js > ../erwin_fork/curb-map/src/assets/data/mtl-subset-outre.curblr.json             
echo "done"
