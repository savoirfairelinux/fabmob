[![Travis build status shield](https://img.shields.io/travis/kafitz/json-converter/master.svg)](https://travis-ci.org/kafitz/json-converter)
[![Github Release version shield](https://img.shields.io/github/tag/kafitz/json-converter.svg)](https://github.com/kafitz/json-converter/releases)
[![jest](https://facebook.github.io/jest/img/jest-badge.svg)](https://github.com/facebook/jest)


# herdr-json-converter

## What's herdr-json-converter?
...
Hacking the Cozy herdr-json-converter app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/kafitz/json-converter.git
$ cd json-converter
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://json-converter.cozy.tools:8080.
...
If you want to work on herdr-json-converter and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for herdr-json-converter is [kafitz](https://github.com/kafitz), send him/her a :beers: to say hello!
...
herdr-json-converter is developed by kafitz and distributed under the [AGPL v3 license][agpl-3.0].
