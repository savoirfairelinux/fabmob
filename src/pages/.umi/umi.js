...
import findRoute, {
  getUrlQuery,
} from '/home/eanoh/Bureau/Fabmob/old/Curblr/erwin_fork_deployed_curb_map/curb-map/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path:
        '/home/eanoh/Bureau/Fabmob/old/Curblr/erwin_fork_deployed_curb_map/curb-map',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
